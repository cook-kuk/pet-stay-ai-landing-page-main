...
export const products: Product[] = [
  {
    id: 'prod-1', slug: 'calm-snuffle-mat', name: '진정 노즈워크 매트', category: '놀이', price: 32000, discountPrice: 27000,
    tags: ['분리불안', '후각놀이'], image: '/placeholder.jpg', description: '외출 전 집중 미션을 주기 좋은 후각 놀이 매트예요.',
    typeSlugs: ['clingy-lover', 'sensitive-sensor', 'solo-explorer'], reason: '혼자 있는 초반 시간을 안정적으로 시작하도록 도와줘요.',
  },
  {
    id: 'prod-2', slug: 'return-home-brush', name: '귀가 후 릴렉스 브러시', category: '케어', price: 22000, discountPrice: null,
    tags: ['교감', '귀가루틴'], image: '/placeholder-user.jpg', description: '귀가 후 흥분을 낮추며 교감 시간을 만들어주는 브러시예요.',
    typeSlugs: ['clingy-lover', 'love-sprinter', 'attention-seeker'], reason: '재회 직후 과열된 감정을 부드럽게 내려줘요.',
  },
  {
    id: 'prod-3', slug: 'active-walk-harness', name: '액티브 워크 하네스', category: '산책', price: 54000, discountPrice: 49000,
    tags: ['산책', '야외활동'], image: '/placeholder.jpg', description: '장시간 산책과 러닝에 안정적인 고정감을 주는 하네스예요.',
    typeSlugs: ['walk-engine', 'energy-firework', 'adventure-instinct'], reason: '활동량이 높은 타입의 움직임을 편안하게 지지해요.',
  },
  {
    id: 'prod-4', slug: 'door-stay-mat', name: '현관 스테이 매트', category: '훈련', price: 29000, discountPrice: null,
    tags: ['현관훈련', '짖음관리'], image: '/placeholder.jpg', description: '현관 소리에 반응하는 아이들을 위한 스테이 훈련 매트예요.',
    typeSlugs: ['door-radar', 'guard-captain', 'sofa-guardian'], reason: '문 앞 반응을 차분한 대기로 전환하는 데 도움이 돼요.',
  },
  {
    id: 'prod-5', slug: 'home-adventure-box', name: '실내 탐험 박스', category: '놀이', price: 43000, discountPrice: 38000,
    tags: ['탐험', '실내놀이'], image: '/placeholder-logo.png', description: '집 안에서도 새로운 미션을 만들 수 있는 탐험형 놀이 키트예요.',
    typeSlugs: ['solo-explorer', 'home-explorer', 'treat-hunter'], reason: '지루함을 줄이고 탐색 욕구를 건강하게 채워줘요.',
  },
]

export const bundles: Bundle[] = [
  { id: 'bundle-1', slug: 'clingy-lover-starter', name: '애착 안정 스타터 번들', typeSlug: 'clingy-lover', description: '외출 전후 안정감과 교감을 함께 설계하는 베스트 조합', price: 69000, items: ['prod-1', 'prod-2'] },
  { id: 'bundle-2', slug: 'walk-engine-outdoor', name: '산책엔진 아웃도어 번들', typeSlug: 'walk-engine', description: '고에너지 타입의 산책 만족도를 올리는 조합', price: 99000, items: ['prod-3'] },
  { id: 'bundle-3', slug: 'calm-entry-bundle', name: '현관 안정 루틴 번들', typeSlug: 'mixed', description: '현관 반응, 짖음, 귀가 동선을 함께 정리하는 번들', price: 79000, items: ['prod-4', 'prod-2'] },
]
